...
view model =
    ...
    { title = toTitle
    , body =
        [ section [ id "One", class "wrapper style3", style "background-image" backgroundImageStyle ]
            [ div [ class "inner" ]
                [ header [ class "align-center" ]
                    [ p [] [ text "Eleifend vitae urna" ]
                    , h2 [] [ text "Generic Page Template" ]
                    ]
                ]
            ]
        ...
        , section [ id "two", class "wrapper style2" ]
            [ div [ class "inner" ]
                [ div [ class "box" ]
                    [ div [ class "content" ]
                        [ header [ class "align-center" ]
                            [ p [] [ text "maecenas sapien feugiat ex purus" ]
                            , h2 [] [ text "Lorem ipsum dolor" ]
                            ]
                        ...
                        , p [] [ text "Vivamus nec odio ac ligula congue feugiat at vitae leo. Aenean sem justo, finibus sed dui eu, accumsan facilisis dolor. Fusce quis dui eget odio iaculis aliquam vel sed velit. Nulla pellentesque posuere semper. Nulla eu sagittis lorem, a auctor nulla. Sed ac condimentum orci, ac varius ante. Nunc blandit quam sit amet sollicitudin sodales." ]
                        , p [] [ text "Vivamus ultricies mollis mauris quis molestie. Quisque eu mi velit. In et cursus nibh. Donec facilisis, orci sed mollis hendrerit, nunc risus mattis odio, eget efficitur nisl orci a lectus. Aenean finibus neque convallis orci sollicitudin tincidunt. Vivamus lacinia facilisis diam, quis facilisis nisi luctus nec. Aliquam ac molestie enim, ut ultrices elit. Fusce laoreet vulputate risus in tincidunt. Sed commodo mollis maximus. Nullam varius laoreet nibh sit amet facilisis. Donec ac odio vehicula, consequat elit et, sodales justo. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nullam ac auctor mauris, in hendrerit libero." ]
                        ]
                    ]
                ]
            ]
